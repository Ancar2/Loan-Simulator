...
const interestRateSchema = new mongoose.Schema({
  ...
  volatility: { type: Number, required: function() { return this.type === 'variable'; } },
  minRate: { type: Number, required: function() { return this.type === 'variable'; } },
  maxRate: { type: Number, required: function() { return this.type === 'variable'; } },
